...
/*   Updated: 2025/09/19 12:03:29 by david            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const & form) const{
	...
	{
		std::cout << this->getName() << " a pu executer le formulaire " << form.getName() << std::endl;
		form.execute(*this);
	}
	else
	{
		std::cout << this->getName() << " n'a pas pu executer le formulaire " << form.getName() << std::endl;
